...
urlpatterns = [
    ...
    path('finances/expenses/<int:expense_pk>/update/', finances.expense_update, name='expense-update'),
    ...
    path('finances/incomes/<int:income_pk>/update/', finances.income_update, name='income-update'),
